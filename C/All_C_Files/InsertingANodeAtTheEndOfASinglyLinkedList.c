...
void print_data(struct node *head)
{
	...
	//while loop used to update the values to be printed
	while(ptr2 != NULL) {
...
//Program to insert a node at the end of the list
void add_at_end(struct node **head, int data) {
	struct node *ptr3, *temp; 	//Created two pointers
	ptr3 = &head; 	//Assigning the address that head holds to ptr3
	...
	//while loop used to update the address ptr3->link
